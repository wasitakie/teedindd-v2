  ...
  return (
    <>
      <div className="max-w-2xl mx-auto bg-white border rounded-2xl shadow border-gray-300 px-4 py-2 text-center gap-4  my-5">
        <h1 className="text-2xl font-extrabold">ค้นหาที่ดิน </h1>
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M12.433 17.8895C11.7504 16.9012 11.886 15.5637 12.753 14.7325C13.6321 13.8881 14.9766 13.7593 16 14.4215C16.4202 14.6931 16.7498 15.0837 16.947 15.5435C17.1413 15.9988 17.1922 16.5025 17.093 16.9875C16.9933 17.4747 16.7494 17.9207 16.393 18.2675C16.0298 18.6186 15.5721 18.8563 15.076 18.9515C"
                    stroke="#ff5c5c"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
